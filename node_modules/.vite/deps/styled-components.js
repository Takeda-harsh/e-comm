...
var ae = [":", "[", ".", "#"];
function ce(e2) {
  var t2, n2, r2, o2, i2 = void 0 === e2 ? E : e2, s2 = i2.options, a2 = void 0 === s2 ? E : s2, c2 = i2.plugins, u2 = void 0 === c2 ? w : c2, l2 = new stylis_browser_esm_default(a2), d2 = [], h2 = function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
